...
/**CommunityFund
 * @dev This contract will collect vesting Shares, stake to the Boardroom and rebalance PDO, BUSD, WBNB according to DAO.
 */
contract CommunityFund {
    ...
    address public dollar = address(0x5BCcFbd33873A5498F8406146868eDdd5E998962);
    address public bond = address(0xaBdEf2d639855aA69065673F80bec4cEfE1f8Eb0);
    address public share = address(0xC1e3bdF0E580DE25d6A8c2A419Da8C859589eD9d);
    ...
    address public boardroom = address(0x18a07EE8AC3A238345499D39Bb6D24e8a78FDa28);
    ...
    address public dollarOracle = address(0x41C054c5a40A52BDAd66ffC3f03E1437b33795f5);
    address public treasury = address(0x2182374CCe5FAa1D6A5CC14210287c8aff8e1115);

    mapping(address => uint256) public maxAmountToTrade; // PDO, BUSD, WBNB

    address public shareRewardPool = address(0xdCBb9f33CA60d7994162a98C0E3B6a8b1Ef5Bb50);
    mapping(address => uint256) public shareRewardPoolId; // [BUSD] -> [Pool_id]: 0
    mapping(address => address) public lpPairAddress; // [BUSD] -> [LP]: 0xc5b0d73A7c0E4eaF66baBf7eE16A2096447f7aD6
                ...
                if (_dollarPercent > expansionPercent[0]) {
                    ...
                    if (_busdPercent >= expansionPercent[1]) {
                        ...
                        if (_wbnbPercent >= expansionPercent[2]) {
                            ...
                            // short of WBNB
                            uint256 _sellingPdoToBusd = _sellingPdo.div(2);
                            _swapToken(dollar, busd, _sellingPdoToBusd);
                            _swapToken(dollar, wbnb, _sellingPdo.sub(_sellingPdoToBusd));
                        }
                    }
                }
