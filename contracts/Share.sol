...
contract Share is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 80,000 sPDO
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 62900 ether;
    ...
    uint256 public startTime = 1617537600; // 4 April 2021 12:00:00 PM UTC
    uint256 public endTime = startTime + VESTING_DURATION; // 2 April 2022 12:00:00 PM UTC
    ...
    constructor() public ERC20("pDollar Share", "sPDO") {
        _mint(msg.sender, 101 ether); // mint 1 Basis Share for initial pools deployment
        devFund = msg.sender;
    }
